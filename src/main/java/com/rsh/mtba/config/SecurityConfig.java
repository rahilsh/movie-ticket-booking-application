...
import com.rsh.mtba.security.JwtAuthFilter;
        ...
        .authorizeHttpRequests(
            auth ->
                auth
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/theatres/**")
                    .permitAll()
                    ...
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/api/theatres/**")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/api/theatres/**")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/api/screens/**")
                    .hasRole("ADMIN")
